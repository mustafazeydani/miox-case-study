...
export interface ClaimStepPanelProps {
...
interface ClaimStepPanelFrameProps extends ClaimStepPanelProps {
  children?: ReactNode;
}

export function ClaimStepPanelFrame({
  node,
  index,
  total,
  definition,
