...
export function DashboardLoadingState() {
  ...
  return (
    ...
    >
      <Card className="surface-glass rounded-[2rem] border-border/70 shadow-[0_20px_70px_-32px_rgba(5,10,26,0.62)]">
        ...
        <div className="space-y-6">
          <div className="grid gap-4 lg:grid-cols-3">
            {loadingCardKeys.map((key) => (
              <Card
                key={key}
                className="surface-glass rounded-[1.5rem] border-border/70 bg-primary/5"
              >
          ...
          <Card className="surface-glass rounded-[1.75rem] border-border/70 bg-primary/5">
