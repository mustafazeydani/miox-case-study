...
const explainResultFixture = {
  ...
  summary:
    "Outstanding deductions and the document request blocking progress. Upload Occupational Certificate. This explanation is generated by the mock AI route from the submitted claim step payload.",
  highlights: [
